    ...
    $(function () {
        ...
        if (typedTarget.length) {
            var typed = new Typed(typedElement, {
                strings: ['کسب و کار خود را شروع کنید.', 'برای دریافت تخفیف بزرگ تابستانی آماده شوید!'],
                typeSpeed: 50,
                backSpeed: 10,
                loop: true
            });
        ...
        if (typedTargetSecond.length) {
            var typed = new Typed(typedElementSecond, {
                strings: ['کد نویسی شده با jQuery', 'دارای تم های مختلف به سلیقه شما', 'دیزاین فوق العاده و چشم نواز'],
                typeSpeed: 70,
                backSpeed: 10,
                loop: true
            });
